...
var Main = function() {
    ...
    this.lipsum = function(minSentences, maxSentences, minWords, maxWords) {
        ...
        minSentences = cleanedSentences[0];
        maxSentences = cleanedSentences[1];
        minWords = cleanedWords[0];
        maxWords = cleanedWords[1];

        numberOfSentences = self.randomInt(minSentences, maxSentences);

        for (i = 0; i < numberOfSentences; i += 1) {
            count = self.randomInt(minWords, maxWords);
            wordIndex = self.randomInt(0, words.length - count - 1);
